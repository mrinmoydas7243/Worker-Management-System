...
$summary_query = "SELECT 
                    ...
                    AVG(workers.daily_wage) as avg_wage
                  FROM attendance
...
// Get detailed report with wage calculations
$query = "SELECT 
            workers.id,
            workers.name,
            workers.daily_wage,
...
<head>
    ...
    <title>Monthly Report | MAA TARA BUILDERS</title>
    ...
    <style>
        * {
        ...
        /* Print styles */
        @media print {
            .back-button, .month-navigation, .filter-section, .export-btn, .chart-section {
                display: none;
            }
...
<body>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <div class="stat-number"><?php echo $summary['total_workers'] ?? 0; ?></div>
                    <div class="stat-sub">Worked this month</div>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <div class="stat-number"><?php echo number_format($summary['total_overtime'] ?? 0, 1); ?> hrs</div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <?php 
                    $total_possible = ($summary['total_workers'] ?? 0) * date('t', strtotime($month . '-01'));
                    $rate = $total_possible > 0 ? round(($total_days / $total_possible) * 100) : 0;
                    ?>
                    <div class="stat-number"><?php echo $rate; ?>%</div>
                    <div class="stat-sub">Monthly average</div>
                </div>
            </div>
        </div>
        <!-- Filter Section -->
        ...
        <div class="summary-cards">
            <div class="summary-card">
                <div class="summary-label">
                    <i class="fas fa-sun"></i> Full Days
                </div>
                <div class="summary-value"><?php echo $summary['total_full_days'] ?? 0; ?></div>
                <div class="summary-trend">
                    <i class="fas fa-arrow-up"></i> Working days
                </div>
            </div>

            <div class="summary-card">
                <div class="summary-label">
                    <i class="fas fa-clock"></i> Half Days
                </div>
                <div class="summary-value"><?php echo $summary['total_half_days'] ?? 0; ?></div>
            </div>
            ...
            <div class="summary-card">
                ...
                <div class="summary-value"><?php echo $summary['total_absent'] ?? 0; ?></div>
            </div>
            ...
            <div class="summary-card">
                ...
                <div class="summary-value"><?php echo number_format($summary['total_overtime'] ?? 0, 1); ?> hrs</div>
            </div>
        </div>
        ...
        <div class="table-section">
            <div class="table-header">
                <div class="table-title">
                    ...
                    <h2>Worker-wise Attendance Details</h2>
                </div>
            ...
            <div class="table-container">
                ...
                <table id="reportTable">
                    ...
                    <tbody>
                        ...
                        while($row = mysqli_fetch_assoc($result)): 
                            ...
                            $present_days = $row['full_days'] + ($row['half_days'] * 0.5);
                            $earnings = ($row['full_days'] * $row['daily_wage']) + 
                                       ($row['half_days'] * $row['daily_wage'] * 0.5) + 
                                       ($row['total_overtime'] * ($row['daily_wage'] / 8));
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-info">
                                    <i class="fas fa-check"></i> <?php echo number_format($present_days, 1); ?>
                                </span>
                            </td>
                            <td>
                                <span class="badge" style="background: #fed7d7; color: #742a2a;">
                                    <i class="fas fa-times"></i> <?php echo $row['absent_days']; ?>
                                </span>
                            </td>
                            <td>
                                <?php if($row['total_overtime'] > 0): ?>
                                <span class="badge" style="background: #bee3f8; color: #1e4a6b;">
                                    <i class="fas fa-hourglass-half"></i> <?php echo number_format($row['total_overtime'], 1); ?>
                                </span>
                                <?php else: ?>
                                -
                                <?php endif; ?>
                            ...
                            <td>
                                <span class="wage-cell">₹ <?php echo number_format($earnings); ?></span>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
                    <tfoot>
                        <tr class="total-row">
                            ...
                            <td style="font-weight: 700; color: #047857;">₹ <?php echo number_format($grand_total); ?></td>
                        </tr>
                    </tfoot>
                </table>
                <?php else: ?>
                <div class="empty-state">
                    ...
                    <p>No attendance records found for <?php echo $month_display; ?>. Try selecting a different month or take attendance for this period.</p>
    ...
    <script>
            ...
            if(attendanceCtx) {
                new Chart(attendanceCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [
                                <?php echo ($summary['total_full_days'] ?? 0) + ($summary['total_half_days'] ?? 0); ?>,
        ...
        function exportToCSV() {
            ...
            link.href = url;
            link.download = 'monthly_report_<?php echo $month; ?>.csv';
            link.click();
        }
